...
<body>
    ...
    <div id="mobileHeader" class="MobileContainer">
        ...
        <div class="page-wrap">
            ...
            <div class="MobileTopSecondary">
                    <div class="Wrapper">
                    <div class="MobileTopSecondaryText">Bitzaron 2, Tel Aviv</div>
    ...
    <script id="TemplateBox" type="text/x-jQuery-tmpl">
             ...
             <div class="BoxBody">
                ...
                <div class="MessageName" style="position:relative">
                    ...
                    <a href="${link}" target="_blank" style="padding-top:10px; padding-left:10px; position:absolute;">${Name}</a>
                    <br />
                    <span style="padding-top:10px; padding-left:10px; position:absolute;">${Date}</span>
                    <br />
