...
<div id="fb-root"></div>
<asp:LinkButton id="btnFacebook" CssClass="HeaderButton" style="color:inherit; cursor:pointer;  text-decoration:none; float:right" runat="server" 
    onclick="btnFacebook_Click"><span style="font-size:inherit">Login</span></asp:LinkButton>
