...
<%@ Register src="FacebookLoginButton.ascx" tagname="FacebookLoginButton" tagprefix="uc1" %>
  ...
  <div id="PopupBox" class="PopupBox" style="padding:6px; position:relative; width:323px;">
     ...
     <div style="background-color:#EAEDEE;">
         ...
         <div style="color:#5f676c; margin:0 auto; padding-top:20px; padding-bottom:20px; width:250px; font-family:Trebuchet MS, Arial, Sans-Serif; text-align:left;">
             <ul>
             <li>PostAround.Me lets you the ability to post to the people around you!</li>
             <li>Sign up NOW to start posting around your location and reply to others' posts.</li>
