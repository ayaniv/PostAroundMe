...
<div id="ClosePopUp" style="float:right; padding:20px;"><img src="<%=siteUrl %>images/close.png" /></div>
<img id="PopUpLoadingDiv" src="<%=siteUrl %>images/loading.gif" style="display:none; width:64px; height:64px; margin-left:-32px; left:50%; top:30%; z-index:9999; position:absolute;" />
