...
<div id="PopUp" class="PopupBox" style="position:absolute; width:895px; margin-top:20px;  min-height:500px; background-color:#FFF; z-index:200; left:50%; margin-left:-435px; box-shadow: 1px 1px 10px #000; -moz-box-shadow: 1px 1px 10px #000; -webkit-box-shadow: 1px 1px 10px #000; padding-bottom:50px; display:none " >
