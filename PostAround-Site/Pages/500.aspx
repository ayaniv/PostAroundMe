<%@ Page Language="C#" AutoEventWireup="true" CodeFile="500.aspx.cs" Inherits="Pages_Error" %>
...
<uc1:MetaTags ID="MetaTags1" runat="server" />
    ...
    <br />
    <span style="color:#A3A3A3; clear:both; font-size:36px; font-weight:normal; font-family:Georgia,Arial,Sans-Serif">Our server is having an Internal Server Error.
</span>
<br /><br /><br />
