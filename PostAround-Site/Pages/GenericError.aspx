<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GenericError.aspx.cs" Inherits="Pages_Error" %>
...
<uc1:MetaTags ID="MetaTags1" runat="server" />
    ...
    <br />
    <span style="color:#A3A3A3; clear:both; font-size:36px; font-weight:normal; font-family:Georgia,Arial,Sans-Serif">An error has occurred.
</span>
<br /><br /><br />

<span style="font-family:Georgia, Arial, Sans-Serif; color:#424E55; margin-top:20px; float:left; font-size:16px;">
Try to <a title="Refresh" style="color:#6AA1BB;" href="http://postaround.me">reload</a> the page. Or visit our <a style="color:#6AA1BB;" href="http://www.facebook.com/postaround">Facebook Page</a>.
</span>
    </div>
    </form>
</body>
