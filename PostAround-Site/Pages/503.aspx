<%@ Page Language="C#" AutoEventWireup="true" CodeFile="503.aspx.cs" Inherits="Pages_Error" %>
...
<uc1:MetaTags ID="MetaTags1" runat="server" />
    ...
    <br /><br />
    <span style="color:#6AA1BB; clear:both; font-size:48px; font-weight:bold; font-family:Trebuchet MS,Arial,Sans-Serif">503</span>
    <br />
    <span style="color:#A3A3A3; clear:both; font-size:36px; font-weight:normal; font-family:Georgia,Arial,Sans-Serif">Sorry, too many people are posting right now around their location. Service Unavailable at the moment.
</span>
<br /><br /><br />

<span style="font-family:Georgia, Arial, Sans-Serif; color:#424E55; margin-top:20px; float:left; font-size:16px;">
Please come back later. Meanwhile you can Like us on <a style="color:#6AA1BB;" href="http://www.facebook.com/postaround">Facebook</a>.<br />It will keep you posted !
</span>
    </div>
    </form>
</body>
